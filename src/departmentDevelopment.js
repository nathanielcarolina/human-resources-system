...
class DepartmentDevelopment extends Component {
    ...
    getEmployees = _ => {
        fetch('http://localhost:4000/department-employees/3')
    ...
    render() {
        ...
        return (
            <>
                <h4 className="mb-4">Development Department</h4>
                <TableTemplate 
...
export default DepartmentDevelopment;